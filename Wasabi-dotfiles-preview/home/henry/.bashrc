...
-------------------------------------------------------------------------------------------------------------------------------------
|  Script* stored in /usr/share/bin/ |  i          For system information    |  dotfiles             Git repo of config files       |
|  update*   To update and clean     |  c          To clear the terminal     |  dotfiles add [file]  Adds a modified or new [file]  |
