...
- [Kernel error: i801_smbus: SMBus is busy, can't use it!](i801-smbus-smbus-is-busy-cant-use-it.md) - innocuous kernel error showing up in journalctl after boot, resolved by masking the kernel module.
